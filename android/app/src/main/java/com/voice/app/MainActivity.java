...
public class MainActivity extends BridgeActivity {
    ...
    private void showMainMenu() {
        ...
        // Кнопка персонажей в стиле HTML
        Button charactersBtn = new Button(this);
        charactersBtn.setText("👥 Мои персонажи");
        charactersBtn.setTextColor(Color.WHITE);
        charactersBtn.setBackgroundColor(Color.parseColor("#B01A1A"));
        charactersBtn.setPadding(30, 20, 30, 20);
        GradientDrawable btnBg = new GradientDrawable();
        btnBg.setCornerRadius(30);
        btnBg.setColor(Color.parseColor("#B01A1A"));
        charactersBtn.setBackground(btnBg);
        ...
        webBg.setCornerRadius(30);
        webBg.setColor(Color.parseColor("#FF9800"));
    ...
    // ==================== СПИСОК ПЕРСОНАЖЕЙ (В СТИЛЕ HTML) ====================
    ...
    private void showCharacterList() {
        ...
        // Список персонажей (сетка как в HTML)
    ...
    private LinearLayout createCharacterCard(CharacterData data, int index) {
        ...
        cardBg.setColor(Color.parseColor("#111111"));
        cardBg.setStroke(2, Color.parseColor("#2C0C0C"));
        card.setBackground(cardBg);
        
        // Аватар (круглый)
        FrameLayout avatarContainer = new FrameLayout(this);
        LinearLayout.LayoutParams avatarParams = new LinearLayout.LayoutParams(130, 130);
        avatarParams.setMargins(0, 0, 0, 12);
        avatarContainer.setLayoutParams(avatarParams);
        
        GradientDrawable avatarBg = new GradientDrawable();
        avatarBg.setShape(GradientDrawable.OVAL);
        avatarBg.setColor(Color.parseColor("#1A1A1A"));
        avatarBg.setStroke(3, Color.parseColor("#3A0F0F"));
        avatarContainer.setBackground(avatarBg);
        
        // Иконка вместо изображения (так как у нас путь к файлу)
        TextView avatarIcon = new TextView(this);
        avatarIcon.setText(data.isVideo ? "🎬" : "🖼️");
        avatarIcon.setTextSize(48);
        avatarIcon.setGravity(Gravity.CENTER);
        avatarIcon.setLayoutParams(new FrameLayout.LayoutParams(
        ...
        nameText.setPadding(10, 8, 10, 8);
        GradientDrawable nameBg = new GradientDrawable();
        nameBg.setCornerRadius(40);
        nameBg.setColor(Color.parseColor("#1A0A0A"));
        nameBg.setStroke(1, Color.parseColor("#3F1414"));
        ...
        floatBtn.setPadding(15, 8, 15, 8);
        floatBtn.setTextSize(14);
        ...
        screenBtn.setPadding(15, 8, 15, 8);
        screenBtn.setTextSize(14);
    ...
    private void showAddCharacterDialog() {
        ...
        bg.setColor(Color.parseColor("#161616"));
        ...
        // Поле ввода имени (ИСПРАВЛЕНО - клавиатура будет появляться)
        ...
        imageBtnBg.setCornerRadius(30);
        imageBtnBg.setColor(Color.parseColor("#B01A1A"));
        imageBtn.setBackground(imageBtnBg);
        ...
        GradientDrawable videoBtnBg = new GradientDrawable();
        videoBtnBg.setCornerRadius(30);
        videoBtnBg.setColor(Color.parseColor("#D42A2A"));
        videoBtn.setBackground(videoBtnBg);
        ...
        cancelBg.setCornerRadius(30);
        cancelBg.setColor(Color.parseColor("#2A2A2A"));
        cancelBg.setStroke(1, Color.parseColor("#4A4A4A"));
