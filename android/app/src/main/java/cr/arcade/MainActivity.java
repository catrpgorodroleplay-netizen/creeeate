...
public class MainActivity extends BridgeActivity {
    ...
    private void cleanupResources() {
        ...
        if (characterContainer != null && windowManager != null) {
            try { windowManager.removeView(characterContainer); } catch (Exception e) {}
        }
    ...
    private void showMainMenu() {
        try {
            ...
            for (String[] item : menuItems) {
                ...
                TextView iconText2 = new TextView(this);
                iconText2.setText(item[0]);
                iconText2.setTextSize(24);
                iconText2.setPadding(0, 0, 16, 0);
                itemLayout.addView(iconText2);
                ...
                titleText2.setText(item[1]);
                titleText2.setTextColor(Color.WHITE);
                titleText2.setTextSize(18);
                titleText2.setTypeface(null, android.graphics.Typeface.BOLD);
                textLayout.addView(titleText2);
                ...
                arrowText.setText("›");
                arrowText.setTextColor(getThemeColor());
    ...
    private LinearLayout createAutoClickerSettings() {
        ...
        layout.addView(saveSettingsBtn);
    ...
    private void showSettingsWindow() {
        try {
            ...
            recordSwitch.setChecked(recordPassThrough);
        ...
        try {
            ...
            deleteAllBtn.setOnClickListener(v -> {
                ...
                confirm.setPositiveButton("Удалить", (d, w) -> {
                    clearAllData();
                    Toast.makeText(MainActivity.this, "Все данные удалены", Toast.LENGTH_SHORT).show();
                });
    ...
    private void restoreBackup() {
        ...
        startActivityForResult(Intent.createChooser(intent, "Выберите резерв"), REQUEST_IMPORT_CONFIG);
    }
    ...
    private void saveWindowsState() {
        try {
            ...
            for (String type : windows.keySet()) {
                ...
                obj.put("x", win.params.x);
                obj.put("y", win.params.y);
                obj.put("width", win.params.width);
                obj.put("height", win.params.height);
                array.put(obj);
            }
        ...
        if (requestCode == REQUEST_IMPORT_CONFIG && resultCode == RESULT_OK && data != null) {
            ...
            if (uri != null) {
                try {
                    ...
                    // Проверяем, это резервная копия или просто конфиг
                    JSONObject root = new JSONObject(json);
                    JSONArray array;
                    if (root.has("macros")) {
                        array = root.getJSONArray("macros");
                    } else {
