...
public class MainActivity extends BridgeActivity {
    ...
    private FrameLayout tagOverlayContainer;
    ...
    private void showFriendsMenu() {
        try {
            ...
            // Запускаем захват экрана если есть друзья
    ...
    private void captureAndAnalyze() {
        ...
        // Анализируем (упрощенная версия - имитация)
        // В реальном проекте здесь OCR
        analyzeScreen(bitmap);
    }
    
    private void analyzeScreen(Bitmap bitmap) {
        // Имитация поиска ников на экране
